...
use App\Http\Controllers\superAdmin\OtpController;
...
Route::group(['prefix' => 'companies'], function () {
    Route::get('/', 'App\Http\Controllers\superAdmin\CompanyController@index')->name('superadmin.companies.index');
    Route::post('store', 'App\Http\Controllers\superAdmin\CompanyController@store')->name('superadmin.companies.store');
    Route::get('edit/{id}', 'App\Http\Controllers\superAdmin\CompanyController@edit')->name('superadmin.companies.edit');
    Route::post('update', 'App\Http\Controllers\superAdmin\CompanyController@update')->name('superadmin.companies.update');
    Route::post('/delete-company', 'App\Http\Controllers\superAdmin\CompanyController@destroy')->name('superadmin.companies.delete');
});


Route::post('logout', 'App\Http\Controllers\UserDashboardController@logout')->name('logout');
...
Route::get('/forgot-password', [PasswordResetController::class, 'forgotPasswordView'])->name('forgetPassword');
Route::post('/forgot-password-send', [PasswordResetController::class, 'forgotPassword'])->name('forgetPasswordSend');
...
/* Route for interviewer section without admin */
Route::group(['prefix' => 'interviewer'], function () {
    Route::get('login', 'App\Http\Controllers\superAdmin\DashboardController@superAdminLogin')->name('interviewer');
    Route::get('dashboard', 'App\Http\Controllers\interviewer\DashboardController@index')->name('interviewer.dashboard');
...
// Route::get('{pagename}/login', [UserDashboardController::class, 'login'])->name('fundraisingLogin');
...
// Route::group(['prefix' => 'user', 'middleware' => ['userAccess']], function () {
    Route::group(['prefix' => 'candidate'], function () {
        Route::get('login', 'App\Http\Controllers\superAdmin\DashboardController@superAdminLogin')->name('superAdminLogin');
        Route::get('index', 'App\Http\Controllers\candidate\CandidateController@index')->name('candiate.index');
        Route::post('store', 'App\Http\Controllers\candidate\CandidateController@storeMeeting')->name('candiate.store');
        Route::get('get-meeting', 'App\Http\Controllers\candidate\CandidateController@getMeeting')->name('candiate.get-meeting');
    });
    
    Route::group(['prefix' => 'interviewer'], function () {
        Route::get('login', 'App\Http\Controllers\superAdmin\DashboardController@superAdminLogin')->name('superAdminLogin');
        Route::get('index', 'App\Http\Controllers\interviewer\interviewerController@index')->name('interviewer.index');
        Route::post('store', 'App\Http\Controllers\interviewer\interviewerController@storeMeeting')->name('interviewer.store');
        Route::get('get-meeting', 'App\Http\Controllers\interviewer\interviewerController@getMeeting')->name('interviewer.get-meeting');
    });
// });