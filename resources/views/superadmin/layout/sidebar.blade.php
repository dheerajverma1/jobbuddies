            ...
            <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="{{ (request()->is('admin/zoom-call')) ? 'nav-link active' : 'nav-link' }}" href="{{ route('superadmin.companies.index') }}">
                            <div class="sb-nav-link-icon">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button"
                            ...
                            @php
                                ...
                                if (
                                    Auth::user()->image &&
                                    file_exists(public_path('storage/images/' . Auth::user()->image))
                                ) {
                        ...
                        <ul class="dropdown-menu dropdown-menu-right shadow-sm border-0"
                            ...
                            <li><a class="dropdown-item"
                                    href="{{ route('superadmin.settings.profile') }}">Settings</a></li>
