...
<div class="modal fade" id="addMeetingsModal" tabindex="-1" aria-labelledby="addMeetingsModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form id="addMeetingsForm" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="interviewer" id="edit_assigned_teacher"
                                    aria-label="Default select example">
                                    <option value="" id="diseaseNullValue" disabled selected>Select Interviewer
                                    </option>
                                    @foreach ($interviewers as $interviewer)
                                        @if (Auth::user()->role == \App\Models\User::INTERVIEWER )
                        ...
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="candidate" id="edit_assigned_teacher"
                                    aria-label="Default select example">
                                    <option value="" id="diseaseNullValue" disabled selected>Select Candidate
                                    </option>
                        ...
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="end_time" id="end_time" placeholder=""
                                    value="">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-6">
                        ...
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" name="meeting_password"
                                    id="meeting_password" placeholder="" value="">
                            </div>
                        </div>
                ...
                <div class=" modal-footer justify-content-center">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                        id="addplanCloseBtn">Cancel</button>
